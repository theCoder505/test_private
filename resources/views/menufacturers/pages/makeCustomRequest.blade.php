            ...
            <div class="main-body">
                <div class="page-wrapper">
                    ...
                    <div class="page-body">
                        ...
                        <h2 class="centered_text"> Add New Custom Project for Influencer </h2>

                        <div class="portal_line">

                            <div id="complete_profile">
                                <form action="/menufacturer/new-custom-project-add" method="post"
                                    enctype="multipart/form-data">
                                    @csrf


                                    <div class="form-group">
                                        <label for="">Project For?</label>
                                        <select name="prod_for" id="" class="form-control">
                        ...
                        <div class="all_added_projects">
                            @forelse ($all_cstm_products as $key => $item)
                                <div class="product_line">
                                    ...
                                    <a href="/menufacturer/edit-product/{{ $item->sno }}" class="btn btn-dark btn-block">
                                        View Product
                                    </a>
                                    @if ($item->order_for == 'influencer')
                                        <button
                                            onclick="copyUrl('{{ url('/') }}/see-custom-product/{{ $item->sno }}/{{ $item->product_category }}/{{ $item->item_name }}')"
