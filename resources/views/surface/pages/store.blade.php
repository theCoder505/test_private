                ...
                <div class="center_items col-md-6">
                    <div class="text_holder">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control w-100" name="chain_1_long_text" id="richTextEditor" rows="7">{!! $item->chain_1_long_text !!}</textarea>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row ecomLine">
                ...
                <div class="center_items col-md-6">
                    <div class="text_holder">
                        ...
                        <div class="form-group">
                            <label for="">Content For Learn More Page</label>
                            <textarea class="form-control w-100" name="chain_2_long_text" contenteditable="true" id="richTextEditor"
            ...
            <div class="row ecomLine">
                <div class="center_items col-md-6">
                    <div class="text_holder">
                        ...
                        <div class="form-group">
                            <label for="">Content For Learn More Page</label>
                            <textarea class="form-control w-100" name="chain_3_long_text" id="richTextEditor" rows="7">{!! $item->chain_3_long_text !!}</textarea>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row ecomLine">
                ...
                <div class="center_items col-md-6">
                    <div class="text_holder">
                        ...
                        <div class="form-group">
                            <label for="">Content For Learn More Page</label>
                            <textarea class="form-control w-100" name="chain_4_long_text" id="richTextEditor" rows="7"> {!! $item->chain_4_long_text !!}</textarea>
                        </div>
                    </div>
                </div>
            </div>
