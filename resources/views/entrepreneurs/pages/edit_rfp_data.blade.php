                                    ...
                                    <form action="/entrepreneur/edit-particular-rfp-post" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="rfp_for" class="form-control" required>
                                                <option @if ($item->rfp_for == 'influencer') selected @endif
                                                    value="influencer">
                                                    Influencer
                                                </option>
                                                <option @if ($item->rfp_for == 'menufacturer') selected @endif
                                                    value="menufacturer">
                                                    Menufacturer
                                                </option>
                                            </select>
                                        ...
                                        <a href="/entrepreneur/see-rfp-responses/{{ $rfp_serial }}/{{ $rfp_category }}/{{ $rfp_title }}"
