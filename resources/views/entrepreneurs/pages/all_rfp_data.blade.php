                    ...
                    <div class="page-body">
                        ...
                        <div class="rfp_holder">
                            ...
                            <div class="portal_line">
                                ...
                                <form action="/entrepreneur/create-new-rfp-post" method="post"
                            ...
                            <div class="item_grid_4">
                                ...
                                @forelse ($all__related_rfps as $item)
                                    <div class="item_grid_line">
                                        ...
                                        <a href="/entrepreneur/view-or-edit-rpf/{{ $item->sno }}/{{ $item->category }}/{{ $item->title }}"
                                            class="btn px-4 mb-2 btn-sm btn-dark">View</a>
                                        <a href="/entrepreneur/delete-rpf/{{ $item->sno }}/{{ $item->category }}/{{ $item->title }}"
