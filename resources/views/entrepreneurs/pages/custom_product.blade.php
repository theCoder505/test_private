                    ...
                    <div class="page-body">
                        ...
                        @forelse ($particular_product as $item)
                            <div class="product_show_page">
                                ...
                                <form action="/entrepreneur/send-custom-request-product-to-order" method="post">
                                    @csrf
                                    ...
                                    <div class="row border_bottom">
                                        ...
                                        <div class="col-md-7 left_side_border">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <a href="/see-vendor-profile/{{ $item->vendor_type }}/{{ $item->vendor_unique_id }}"
                                                    class="btn px-3 mt-2 btn-dark">Visit Profile</a>
                                            </div>
