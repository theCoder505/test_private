...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/86huv8mqdk27xmp7aa620j1jos97ufurmoenj35tsqgo3wcy/tinymce/5/tinymce.min.js"></script>
...
<body>
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
            @include('influencers.layouts.header')
            @include('influencers.layouts.sidebar')
