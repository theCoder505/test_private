                            ...
                            @forelse ($spec_rfp as $item)
                                <div class="row container">
                                    ...
                                    <div class="col-12">
                                        ...
                                        @else
                                            <form action="/influencer/add-response-on-rfp" method="post">
                                                @csrf
                                                <input type="hidden" name="bid_over" value="{{ $item->sno }}">
                                                <input type="hidden" name="rfp_for_user_type" value="{{ $item->rfp_creator_type }}">
                                                <input type="hidden" name="rfp_for_user_id" value="{{ $item->rfp_creator_id }}">
