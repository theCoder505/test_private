                                ...
                                <tbody>
                                    ...
                                    @forelse ($ongoing_orders as $key => $item)
                                        <tr>
                                            ...
                                            <td scope="col">
                                                <a href="/see-product/{{ $item->product_serial }}/{{ $item->prod_cat }}/{{ $item->prod_name }}"
                                ...
                                <tbody>
                                    ...
                                    @forelse ($all_completed_orders as $key => $item)
                                        <tr>
                                            ...
                                            <td scope="col">
                                                <a href="/review-order/{{ $item->sno }}/{{ $item->product_serial }}/{{ $item->prod_cat }}/{{ $item->prod_name }}"
                                                    class="btn btn-sm btn-primary px-3">View</a>
                                            </td>
                                        </tr>
                        ...
                        <div class="portal_line">
                            ...
                            <table class="table" id="order_table2">
                                ...
                                <tbody>
                                    ...
                                    @forelse ($orders_to_deliver as $key => $item)
                                        <tr>
                                            <td scope="col">{{ $key + 1 }}</td>
                                            <td scope="col"> <img src="{{ $item->prod_image }}" alt=""
                                                    class="left_img"></td>
