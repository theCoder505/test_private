                        ...
                        <div class="portal_line">
                            ...
                            <div id="complete_profile">
                                <form action="/influencer/complete-user-profile" method="post"
                                    ...
                                    <div class="form-group">
                                        <label>Name Of Persons</label>
                                        <input type="text" class="form-control" required value="{{ $persons_name }}"
                                            placeholder="Name of some important persons od your company"
                                            name="persons_name">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" required value="{{ $linkedin_url }}"
                                            name="linkedin_url">
                                    </div>

                                    <div class="form-group">
                                        <label> Website URL </label>
                                        <input type="text" class="form-control" required value="{{ $website_url }}"
                                            name="website_url">
                                    </div>

                                    <div class="form-group">
                                        <label> Instagram Page URL </label>
                                        <input type="text" class="form-control" required value="{{ $insta_url }}"
                                            name="insta_url">
                                    </div>

                                    <div class="form-group">
                                        <label> Facebook Page URL </label>
                                        <input type="text" class="form-control" required value="{{ $fb_url }}"
                                            name="fb_url">
                                    </div>

                                    <div class="form-group">
                                        <label> Affiliate Links </label>
                                        <input type="text" class="form-control" placeholder="Share Your Affiliate Link, if any." value="{{ $affiliate_url }}"
                                            name="affiliate_url">
                                    </div>
