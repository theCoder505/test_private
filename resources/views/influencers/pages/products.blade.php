            ...
            <div class="main-body">
                <div class="page-wrapper">
                    ...
                    <div class="page-body">
                        ...
                        <h2 class="centered_text"> Add New Project {{ $appname }} </h2>

                        <div class="portal_line">

                            <div id="complete_profile">
                                <form action="/influencer/add-new-project" method="post" enctype="multipart/form-data">
                                    @csrf
                        ...
                        <h3 class="headline_text mt-5">
                            All Your {{ $appname }} Products
                        </h3>

                        <div class="all_added_projects">
                            @forelse ($all_products as $key => $item)
                                <div class="product_line">
                                    ...
                                    <a href="/influencer/edit-product/{{ $item->sno }}" class="btn btn-dark btn-block">
                                        View Product
                                    </a>
                                </div>
                            @empty
